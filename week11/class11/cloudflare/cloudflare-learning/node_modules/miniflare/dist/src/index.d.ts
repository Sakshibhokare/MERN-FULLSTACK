...
export declare const CONTAINER_PLUGIN: Plugin<typeof ContainersOptionsSchema, typeof ContainersSharedSchema>;
...
export declare class ContainerController {
    ...
    }, sharedOptions: ContainersSharedOptions, logger: Log);
    updateConfig(containerOptions: {
        [className: string]: ContainerOptions;
    }, sharedOptions: ContainersSharedOptions): void;
    buildAllContainers(): Promise<void>;
    buildContainer(options: ContainerOptions): Promise<void>;
    checkExposedPorts(imageTag: string): Promise<void>;
}

export declare type ContainerOptions = z.infer<typeof ContainerSchema>;
...
export declare const ContainerSchema: z.ZodObject<{
    ...
    args: z.ZodDefault<z.ZodRecord<z.ZodString, z.ZodString>>;
...
export declare type ContainersSharedOptions = z.infer<typeof ContainersSharedSchema>;

export declare const ContainersSharedSchema: z.ZodObject<{
    enableContainers: z.ZodDefault<z.ZodBoolean>;
    dockerPath: z.ZodDefault<z.ZodString>;
}, "strip", z.ZodTypeAny, {
...
export declare type SharedOptions = z.input<typeof CORE_PLUGIN.sharedOptions> & z.input<typeof CACHE_PLUGIN.sharedOptions> & z.input<typeof D1_PLUGIN.sharedOptions> & z.input<typeof DURABLE_OBJECTS_PLUGIN.sharedOptions> & z.input<typeof KV_PLUGIN.sharedOptions> & z.input<typeof R2_PLUGIN.sharedOptions> & z.input<typeof WORKFLOWS_PLUGIN.sharedOptions> & z.input<typeof SECRET_STORE_PLUGIN.sharedOptions> & z.input<typeof ANALYTICS_ENGINE_PLUGIN.sharedOptions> & z.input<typeof CONTAINER_PLUGIN.sharedOptions> & z.input<typeof HELLO_WORLD_PLUGIN.sharedOptions>;
